                ...
                <form class="w-full min-w-max">
                    ...
                    <div class="flex -mx-3 mb-6">
                      ...
                      <div class="w-full md:w-1/2 px-3">
                        <label class="block tracking-wide text-[#ACB5BB] text-xs font-bold mb-2" for="grid-last-name">Payment ID</label>
                    ...
                    <div class="w-full mb-6">
                        <label class="block tracking-wide text-[#ACB5BB] text-xs font-bold mb-2" for="grid-state">Type</label>
                        <div class="relative">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-2">
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6">
                            <label class="block tracking-wide text-[#ACB5BB] text-xs font-bold mb-2" for="grid-state">Amount</label>
                            <div class="relative">
                            <select class="appearance-none block w-full text-black placeholder:text-black border border-[#DCE4E8] py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white text-sm" id="grid-state">
                                <option>1260</option>
                                <option>1260</option>
                    ...
                    <div class="flex px-3 mt-9">
                        <button class="px-5 py-2 brand-blue border border-[#5329FF] font-bold text-white mr-4">Add Payments</button>
