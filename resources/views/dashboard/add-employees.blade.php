                ...
                <form class="w-full min-w-max">
                    ...
                    <div class="flex -mx-3 mb-6">
                      ...
                      <div class="w-full md:w-1/2 px-3">
                        <label class="block tracking-wide text-[#ACB5BB] text-xs font-bold mb-2" for="grid-last-name">Employee Address</label>
                    ...
                    <div class="flex px-3 mt-9">
                        <button class="px-5 py-2 brand-blue border border-[#5329FF] font-bold text-white mr-4">Add Employees</button>
